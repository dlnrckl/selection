...
def process_files(input_vcf, output_vcf):
...
def main():
    parser = argparse.ArgumentParser(description="Flip VCF REF/ALT using Ensembl ancestor FASTA so that REF=ancestral")
...
### usage: python flip2.py input.vcf output_flipped.vcf
